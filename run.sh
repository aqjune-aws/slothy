...
#    -c reserved_regs="[x18,sp]" -c outputs=[hint_buffer32,hint_buffer48,hint_buffer64,hint_buffer80,hint_buffer96,hint_buffer112] \
...
${SLOTHY_DIR}/slothy-cli Arm_AArch64 Arm_Cortex_A55                          \
    ...
    -c outputs=$OUTPUTS -c reserved_regs="[x18,sp]"         \
...
i=0
    ...
    -c max_solutions=512                                                     \
    -c timeout=300                                                           \
    -c constraints.stalls_first_attempt=0                                   \
    -c split_heuristic                                                       \
